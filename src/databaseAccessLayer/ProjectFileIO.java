...
public class ProjectFileIO implements FileIO{
	 ...
	 * 
	 * @param data	ArrayList of data to be stored, formatted: id, name, date, descr
	 */
	@Override
	...
	public ArrayList<ArrayList<String>> read() {
		...
		// Create an ArrayList that contains entries in ProjectFile in format: (id, Name, Date, Descr)
	...
	public ArrayList<String> readID(String id) {
		...
		// Create an ArrayList that will contain an entry in ProjectFile in format: (id, Name, Date, Descr)
		...
		try {
			...
			while (line != null) {
				...
				// If the ID (first field) equals the given id, return the entry
	...
	public void deleteEntry(String id) {
		...
		try {
			...
			File inFile = new File("./database/ProjectFile.txt");
