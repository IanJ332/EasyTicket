...
public class CommentFileIO implements FileIO{
	...
	public void store(ArrayList<String> data) {
		...
		try {
			writer = new BufferedWriter(new FileWriter("./database/CommentFile.txt", true));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public ArrayList<ArrayList<String>> read() {
		...
		try {
			reader = new BufferedReader(new FileReader("./database/CommentFile.txt"));
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		}

		// Create an ArrayList of entries in CommentFile in the format (id, TicketId, Timestamp, Descr)
	...
	public ArrayList<String> readID(String id) {
		...
		try {
			...
			while (line != null) {
				...
				// if ID (first field) matches the input id, return the entry
	...
	public void deleteEntry(String id) {
		...
		try {
			File inFile = new File("./database/CommentFile.txt");
